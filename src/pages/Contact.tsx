      ...
      <section className="section-padding">
        <div className="container-max grid gap-12 lg:grid-cols-5">
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="space-y-6 lg:col-span-2">
            ...
            {[
              { icon: MapPin, label: "Address", value: "Mombasa Road, Industrial Area\nNairobi, Kenya" },
              { icon: Phone, label: "Phone", value: "+254 700 000 000" },
              { icon: Mail, label: "Email", value: "info@barcold.co.ke" },
            ...
            <div className="overflow-hidden rounded-xl border">
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.819!2d36.849!3d-1.303!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMcKwMTgnMTAuOCJTIDM2wrA1MCc1Ni40IkU!5e0!3m2!1sen!2ske!4v1610000000000!5m2!1sen!2ske"
                width="100%"
                height="200"
                style={{ border: 0 }}
                allowFullScreen
